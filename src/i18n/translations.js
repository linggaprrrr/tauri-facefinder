...
export const translations = {
  ...
  'upload.hint':           { id: 'Letakkan kotak QR di canvas, lalu pindai dengan HP untuk mengirim foto Anda sendiri. Foto langsung muncul di sini.', en: 'Place a QR box on the canvas, then scan it with your phone to send your own photo. It appears here automatically.' },
  'upload.add':            { id: 'Tambah Kotak Foto', en: 'Add Photo Box' },
  ...
  'upload.step1':          { id: 'Ketuk "Tambah Kotak Foto" — kotak QR muncul di canvas.', en: 'Tap "Add Photo Box" — a QR box appears on the canvas.' },
  'upload.step2':          { id: 'Pindai QR itu dengan kamera HP Anda.', en: 'Scan that QR with your phone camera.' },
  'upload.step3':          { id: 'Pilih foto di HP — foto otomatis mengisi kotaknya.', en: 'Pick a photo on your phone — it fills the box automatically.' },
