...
export const translations = {
  ...
  'settings.syncHint':       { id: 'Ambil ulang stiker, bingkai, template AI, metode akses, dan template cetak. Perubahan branding tetap menunggu kiosk dinyalakan ulang.', en: 'Refetch stickers, frames, AI templates, access methods and print templates. Branding changes still wait for the next restart.' },
  'settings.syncBtn':        { id: 'Sinkronkan Sekarang', en: 'Sync now' },
  'settings.syncing':        { id: 'Menyinkronkan…', en: 'Syncing…' },
  'settings.syncDone':       { id: 'Tersinkron. Konten baru dimuat saat layar berikutnya dibuka.', en: 'Synced. New content loads as each screen is next opened.' },
