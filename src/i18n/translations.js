...
export const translations = {
  ...
  'scan.howTitle':      { id: 'Cara Pindai Wajah', en: 'How to scan' },
  'scan.step1':         { id: 'Hadap tepat ke kamera', en: 'Face the camera directly' },
  'scan.step2':         { id: 'Posisikan wajah di dalam oval', en: 'Position your face inside the oval' },
  'scan.step3':         { id: 'Tersenyum secara natural', en: 'Smile naturally' },
  'scan.tipsTitle':     { id: 'Tips', en: 'Tips' },
  'scan.tip1':          { id: 'Lepas kacamata hitam', en: 'Take off sunglasses' },
  ...
  'gallery.previewAria': { id: 'Pratinjau {name}', en: 'Preview {name}' },
  'gallery.sortLabel':   { id: 'Urutkan', en: 'Sort' },
  'gallery.sortMatch':   { id: 'Paling Mirip', en: 'Best match' },
  'gallery.sortNewest':  { id: 'Terbaru', en: 'Newest' },
  'gallery.sortPrice':   { id: 'Harga', en: 'Price' },
  'gallery.noMatchTitle':{ id: 'Tidak ada hasil', en: 'No results' },
  'gallery.noMatchDesc': { id: 'Tidak ada foto yang cocok dengan pencarian atau filter Anda.', en: 'No photos match your search or filter.' },
  'gallery.clearFilters':{ id: 'Hapus Filter', en: 'Clear filters' },
  ...
  'cart.summaryTitle':    { id: 'Ringkasan Pesanan', en: 'Order Summary' },
  'cart.rowItems':        { id: 'Total Item', en: 'Total items' },
  'cart.rowPhotos':       { id: 'Foto', en: 'Photos' },
  'cart.rowAi':           { id: 'Foto AI', en: 'AI photos' },
  'cart.rowFrame':        { id: 'Foto Frame', en: 'Frame photos' },
  'cart.rowPrints':       { id: 'Total Cetak', en: 'Total prints' },
  'cart.subtotalPhotos':  { id: 'Subtotal foto', en: 'Photo subtotal' },
  'cart.subtotalPrints':  { id: 'Subtotal cetak', en: 'Print subtotal' },
  'cart.secureNote':      { id: 'Pembayaran diproses dengan aman.', en: 'Payment is processed securely.' },
  ...
  'print.addHint':       { id: 'Opsional — tambahkan cetakan fisik untuk dibawa pulang.', en: 'Optional — add a physical print to take home.' },
  ...
  'print.addOne':        { id: 'Tambah', en: 'Add' },
  'print.addAnother':    { id: 'Tambah Lagi', en: 'Add another' },
  ...
  'print.copiesMore':    { id: 'Tambah jumlah cetak', en: 'Increase copies' },
  'print.copiesLess':    { id: 'Kurangi jumlah cetak', en: 'Decrease copies' },
  ...
  'editor.prevPhoto':      { id: 'Foto sebelumnya', en: 'Previous photo' },
  'editor.nextPhoto':      { id: 'Foto berikutnya', en: 'Next photo' },
  'editor.addPhoto':       { id: 'Tambah', en: 'Add' },
  'editor.elSticker':      { id: 'Stiker', en: 'Sticker' },
  'editor.elText':         { id: 'Teks', en: 'Text' },
  'editor.elUpload':       { id: 'Foto Ponsel', en: 'Phone photo' },
  ...
  'toolbar.duplicate': { id: 'Duplikat', en: 'Duplicate' },
  'toolbar.flip':      { id: 'Balik', en: 'Flip' },
  'toolbar.zoomIn':    { id: 'Perbesar', en: 'Zoom in' },
  'toolbar.zoomOut':   { id: 'Perkecil', en: 'Zoom out' },
  'toolbar.zoomReset': { id: 'Kembalikan ukuran', en: 'Reset zoom' },
  ...
  'sticker.all':     { id: 'Semua', en: 'All' },
  'sticker.noMatch': { id: 'Stiker tidak ditemukan', en: 'No stickers found' },
