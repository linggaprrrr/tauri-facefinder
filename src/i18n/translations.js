...
export const translations = {
  ...
  'settings.syncHint':       { id: 'Ambil ulang branding, stiker, bingkai, template AI, metode akses, dan template cetak. Aplikasi akan dimuat ulang.', en: 'Refetch branding, stickers, frames, AI templates, access methods and print templates. The app will reload.' },
  'settings.syncBtn':        { id: 'Sinkronkan Sekarang', en: 'Sync now' },
  'settings.syncing':        { id: 'Menyinkronkan…', en: 'Syncing…' },
  'settings.syncConfirm':    { id: 'Ada sesi pelanggan yang sedang berjalan. Sinkronisasi akan memuat ulang aplikasi dan mengosongkan foto yang sudah dipilih. Lanjutkan?', en: 'A customer session is in progress. Syncing reloads the app and clears the selected photos. Continue?' },
  'settings.syncConfirmYes': { id: 'Ya, sinkronkan', en: 'Yes, sync' },
  'settings.syncCancel':     { id: 'Batal', en: 'Cancel' },
