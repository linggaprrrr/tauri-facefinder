...
// fetched and converted to a dataURL. Original photos never go through
// printFromUrl's raw-bytes path; everything funnels through a dataURL so it
// can be composed onto the template and persisted in the local print queue
